 ...
 *
 */
public class PadayonEngineering {
    public static void main(String[] args) {
        ...
        System.out.println(" ");
        System.out.println("Welcome, this program will help you in your conversion");
        ...
        int number = input.nextInt();
            ...
            switch (number) {
                case 1:
                    while(true){
                        System.out.println(" ");
                        System.out.println( "Welcome to temperature converter. Choose what you want to convert: ");
